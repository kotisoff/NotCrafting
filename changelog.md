...
## 0.2.0b Вынужденное превью мультиплеер обновы

- Переписан весь движок рецептов
- Мод переписан под клиент-серверную архитектуру с поддержкой синглплеера
- Больше: чекайте коммит-историю на гите

### Ваще релиз вынужденный, поскольку прошлые версии тупо не работают (ну или кажется что не работают) на новых версиях движка

## 0.2.0 Полноценный релиз мультиплеера (SOON™)
